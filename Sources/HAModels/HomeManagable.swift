...
public enum HomeManagableAction: CustomStringConvertible, Sendable, Codable, Hashable, Equatable {
    public enum SceneEntityAction: Sendable, Codable, Hashable, Equatable {
        case lockDoor
        case on
        case off
    }
